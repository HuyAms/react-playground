    ...
    return (
        <form action={formAction}>
            <div className="flex flex-col gap-2">
                ...
                <input name="email" className="border border-gray-300 rounded-md p-2" type="email" id="email" />
                <label htmlFor="password">Password</label>
                <input name="password" className="border border-gray-300 rounded-md p-2" type="password" id="password" />
                <label htmlFor="confirmPassword">Confirm Password</label>
                <input name="confirmPassword" className="border border-gray-300 rounded-md p-2" type="password" id="confirmPassword" />
